...
\author{Jeffrey L. Neyhart\textsuperscript{*} and ...} % Author(s)
...
\begin{figure}
  \includegraphics[width=1\linewidth]{figure.jpg}
\end{figure}
...
%% Figure
\begin{figure}
  \includegraphics[width=1\linewidth]{figures/figure.jpg}
\end{figure}
...
\begin{figure}
  \includegraphics[width=0.90\linewidth]{figures/figure.jpg}
\end{figure}
